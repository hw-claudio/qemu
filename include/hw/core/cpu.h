...
typedef struct TcgCpuOperations {
     ...
     */
    void (*synchronize_from_tb)(CPUState *cpu, const struct TranslationBlock *tb);
    ...
    /**
     * @adjust_watchpoint_address: hack for cpu_check_watchpoint used only by arm
     */
    vaddr (*adjust_watchpoint_address)(CPUState *cpu, vaddr addr, int len);

    /**
     * @debug_check_watchpoint: return true if the architectural
     * watchpoint whose address has matched should really fire. Used only by arm
     */
