...
class BootOVMF(FirmwareTest):
    """
    Boots a OVMF Firmware and checks that the console shows the expected message.
    Note that a TIMEOUT here is an ERROR, ie we could not see the expected message.
    """
    timeout = 10
