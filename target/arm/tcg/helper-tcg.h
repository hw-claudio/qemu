...
extern const ARMCPRegInfo v8_cp_reginfo_sysemu[];
extern const ARMCPRegInfo el2_cp_reginfo_sysemu[];
extern const ARMCPRegInfo vhe_reginfo_sysemu[];
extern const ARMCPRegInfo vapa_cp_reginfo_sysemu[];
