...
static void kvm_cpu_realizefn(DeviceState *dev, Error **errp)
{
    ...
    fprintf(stdout, "kvm_cpu_realizefn\n");
    /*
...
static void kvm_cpu_common_class_init(ObjectClass *oc, void *data)
{
    ...
    fprintf(stdout, "kvm_cpu_common_class_init\n");
...
static void kvm_cpu_max_initfn(Object *obj)
{
    ...
    fprintf(stdout, "kvm_cpu_max_initfn\n");
...
{
    fprintf(stdout, "kvm_cpu_type_init\n");
    x86_cpu_register_cpu_types(X86_CPU_TYPE_NAME("kvm"));
}
