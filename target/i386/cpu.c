...
/*
 * only relevant for cpu models initialized with x86_register_cpudef_types (builtin_x86_defs)
 */
 ...
 * max, base and their subclasses are not registered here, see x86_cpu_register_types.
 */
