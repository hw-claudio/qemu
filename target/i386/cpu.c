...
static void max_x86_cpu_class_init(ObjectClass *oc, void *data)
{
    ...
    fprintf(stdout, "max_x86_cpu_class_init\n");
...
void max_x86_cpu_initfn(Object *obj)
{
    ...
    fprintf(stdout, "max_x86_cpu_initfn\n");
...
static TypeInfo max_x86_cpu_type_info = {
    ...
    .parent = NULL, /* set by x86_cpu_register_cpu_types */
...
static void x86_cpu_cpudef_class_init(ObjectClass *oc, void *data)
{
    ...
    fprintf(stdout, "x86_cpu_cpudef_class_init\n");
...
void x86_cpu_realizefn(DeviceState *dev, Error **errp)
{
    ...
    fprintf(stdout, "x86_cpu_realizefn\n");
...
void x86_cpu_common_class_init(ObjectClass *oc, void *data)
{
    ...
    fprintf(stdout, "x86_cpu_common_class_init\n");
...
static void x86_cpu_base_class_init(ObjectClass *oc, void *data)
{
    ...
    fprintf(stdout, "x86_cpu_base_class_init\n");
...
{
    return x86_base_cpu_type_info.parent != NULL;
}
...
{
    int i;
    fprintf(stdout, "x86_cpu_register_cpu_types\n");
