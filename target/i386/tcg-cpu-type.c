...
static void tcg_cpu_realizefn(DeviceState *dev, Error **errp)
{
    ...
    fprintf(stdout, "tcg_cpu_realizefn\n");
...
static void tcg_cpu_common_class_init(ObjectClass *oc, void *data)
{
    ...
    fprintf(stdout, "tcg_cpu_common_class_init\n");
    
#ifndef CONFIG_USER_ONLY
    device_class_set_parent_realize(dc, tcg_cpu_realizefn,
                                    &xcc->parent_realize);
...
{
    fprintf(stdout, "tcg_cpu_type_init\n");
    x86_cpu_register_cpu_types(X86_CPU_TYPE_NAME("tcg"));
}
